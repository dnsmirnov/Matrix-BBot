...
def main(config):
    ...
    try:
        ...
        # base_url = config.homeserver + "/_matrix/client/api/v1" # Fix error
        # message but if it will be used in future uncomment string
    ...
    # room = client.join_room("#admins:matrix.bingo-boom.ru") # never used
